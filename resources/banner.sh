...
# Print ASCII art
print_ascii_art() {
    printf "${NAVY_BLUE}  SSSSSS\                       SS\                           SS\     SSSSSSSS\       SS\      SS\  SSSSSS\  SSSSSSS\         SSSSSS\                                                       ${NC} \n"
    printf "${NAVY_BLUE} SS  __SS\                      SS |                          SS |    \____SS  |      SSS\    SSS |SS  __SS\ SS  __SS\       SS  __SS\                                                      ${NC} \n"
    printf "${NAVY_BLUE} SS /  \__| SSSSSS\  SSSSSSS\ SSSSSS\    SSSSSS\  SS\   SS\ SSSSSS\       SS  /       SSSS\  SSSS |SS /  \__|SS |  SS |      SS /  \__| SSSSSS\   SSSSSS\ SS\    SS\  SSSSSS\   SSSSSS\     ${NC}\n"
    printf "${NAVY_BLUE} SS |      SS  __SS\ SS  __SS\\_SS  _|  SS  __SS\ \SS\ SS  |\_SS  _|     SS  /SSSSSS\ SS\SS\SS SS |SS |      SSSSSSS  |      \SSSSSS\  SS  __SS\ SS  __SS\\SS\  SS  |SS  __SS\ SS  __SS\    ${NC}\n"
    printf "${NAVY_BLUE} SS |      SS /  SS |SS |  SS | SS |    SSSSSSSS | \SSSS  /   SS |      SS  / \______|SS \SSS  SS |SS |      SS  ____/        \____SS\ SSSSSSSS |SS |  \__|\SS\SS  / SSSSSSSS |SS |  \__|   ${NC}\n"
    printf "${NAVY_BLUE} SS |  SS\ SS |  SS |SS |  SS | SS |SS\ SS   ____| SS  SS<    SS |SS\  SS  /          SS |\S  /SS |SS |  SS\ SS |            SS\   SS |SS   ____|SS |       \SSS  /  SS   ____|SS |         ${NC}\n"
    printf "${NAVY_BLUE} \SSSSSS  |\SSSSSS  |SS |  SS | \SSSS  |\SSSSSSS\ SS  /\SS\   \SSSS  |SS  /           SS | \_/ SS |\SSSSSS  |SS |            \SSSSSS  |\SSSSSSS\ SS |        \S  /   \SSSSSSS\ SS |         ${NC}\n"
    printf "${NAVY_BLUE}  \______/  \______/ \__|  \__|  \____/  \_______|\__/  \__|   \____/ \__/            \__|     \__| \______/ \__|             \______/  \_______|\__|         \_/     \_______|\__|         ${NC}\n"
}
...
printf "${GREEN} >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Starting Context7-MCP Server! <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< \n${NC}"
printf "${ORANGE} ==================================${NC}\n"
